...
**Vídeo executivo:** [A preencher, link após gravação]
...
EDA (4 datasets: alunos completo, amostra histórica, snapshot de
modelagem, território local): [`reports/eda_alunos.md`](reports/eda_alunos.md),
[`reports/eda_alunos_amostra.md`](reports/eda_alunos_amostra.md),
[`reports/eda_snapshot_modelagem.md`](reports/eda_snapshot_modelagem.md),
[`reports/eda_territorio_local.md`](reports/eda_territorio_local.md).
...
por medição, e por isso saem da população de modelagem: **57.781 → 48.055
alunos avaliados**.
...
convergem para o mesmo teto do baseline (medido, não afirmado; ver §7.3). É
...
relação com alfabetização": são alvos diferentes. Contra o **nível** de
...
**A limitação mais consequente: comparação entre estados não é válida.**
