...
| populacao_total                  |  909       | 86326           |    1.23964e+07 |
| meta_alfabetizacao_2024_imputada |    7.94    |    60.14        |   80           |
| meta_is_imputada                 |    0       |     0           |    1           |
...
| populacao_total                  | 86326           |   1.23964e+07 |   1.23964e+07 |    1      |
| meta_alfabetizacao_2024_imputada |    60.14        |  80           |  80           |    1      |
...
| sigla_uf                         |    6081 | 12.65 |
| populacao_total                  |    6081 | 12.65 |
| meta_alfabetizacao_2024_imputada |    6081 | 12.65 |
| _peso_amostral                   |      29 |  0.06 |

### 7. Redundância entre colunas

- `id_escola` ↔ `id_aluno`: correlação 0.979
- `n_alunos_hist_municipio_t1` ↔ `populacao_total`: correlação 0.977
...
**`populacao_total`** — mediana: risco=97650.5000 · não-risco=80561.0000

**`meta_alfabetizacao_2024_imputada`** — mediana: risco=56.1800 · não-risco=63.4400

**`meta_is_imputada`**

|   meta_is_imputada |     n |   % risco |
|-------------------:|------:|----------:|
|                  0 | 41557 |      41.2 |
|                  1 |  6498 |      41.1 |
...
- `populacao_total`: 6081 nulos (12.7%) — risco entre nulos **40.3%** vs **41.4%** no resto
- `sigla_uf`: 6081 nulos (12.7%) — risco entre nulos **40.3%** vs **41.4%** no resto
- `meta_alfabetizacao_2024_imputada`: 6081 nulos (12.7%) — risco entre nulos **40.3%** vs **41.4%** no resto
