...
| `meta_alfabetizacao_2024_imputada` | Silver Fase 2, OBT **com metas imputadas** (KNN, ADR-004) | Direto, join por `id_municipio`+`ano`+`rede` | Meta do PDE: definida externamente por política pública, não deriva do desempenho do aluno predito. Enunciado pede "metas estaduais e municipais" explicitamente. Ver Cap. 6.3 do diário de bordo interno (não publicado) |
