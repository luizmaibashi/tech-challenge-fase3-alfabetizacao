...
PARAMS_XGB = dict(
    ...
    # mesma seed e mesmo dado). Aqui o efeito recai sobre os valores SHAP, que
    # sao lidos como evidencia de negocio -- reprodutibilidade importa mais
    # ainda. Ver docs/wayfinder/tech_challenge_fase3/0009.
